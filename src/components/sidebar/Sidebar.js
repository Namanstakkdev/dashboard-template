              ...
              <ul className="sidebar-menu">
                <li className="treeview">
                  ...
                  <ul className="treeview-menu">
                    <li>
                      <a href="index.html">
                        <i className="icon icon-folder5"></i>Panel Dashboard 1
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="panel-page-dashboard2.html">
                        <i className="icon icon-folder5"></i>Panel Dashboard 2
                      </a>
                    </li>
                    <li>
                      <a href="panel-page-dashboard3.html">
                        <i className="icon icon-folder5"></i>Panel Dashboard 3
                      </a>
                    </li>
                    <li>
                      <a href="panel-page-dashboard4.html">
                        <i className="icon icon-folder5"></i>Panel Dashboard 4
                      </a>
                    </li>
                    <li>
                      <a href="panel-page-dashboard5.html">
                        <i className="icon icon-folder5"></i>Panel Dashboard 5
                      </a>
                    </li>
                    <li>
                      <a href="panel-page-dashboard6.html">
                        <i className="icon icon-folder5"></i>Panel Dashboard 6
                      </a>
                    </li>
                    <li>
                      <a href="panel-page-dashboard7.html">
                        <i className="icon icon-folder5"></i>Panel Dashboard 7
                      </a>
                    </li>
                    <li>
                      <a href="panel-page-dashboard8.html">
                        <i className="icon icon-folder5"></i>Panel Dashboard 8
                      </a>
                    </li>
                    <li>
                      <a href="panel-page-dashboard9.html">
                        <i className="icon icon-folder5"></i>Panel Dashboard 9
                      </a>
                    </li>
                    <li>
                      <a href="panel-page-dashboard10.html">
                        <i className="icon icon-folder5"></i>Panel Dashboard 10
                      </a>
                    </li>
                    <li>
                      <a href="panel-page-dashboard11.html">
                        <i className="icon icon-folder5"></i>Panel Dashboard 11
                      </a>
                    </li>
                  </ul>
                </li>
                  ...
                  <ul className="treeview-menu">
                    ...
                    <li>
                      <a href="panel7-projects-list.html">
                        <i className="icon icon-circle-o"></i>Panel7 - Projects
                        List
                      </a>
                    </li>
                  </ul>
                ...
                <li className="treeview">
                  ...
                  <ul className="treeview-menu">
                    ...
                    <li>
                      <a href="/">
                        <i className="icon icon-fingerprint text-green"></i>Auth
                        Pages<i className=" icon-angle-left  pull-right"></i>
                      </a>
                      <ul className="treeview-menu">
                        <li>
                          <a href="login.html">
                  ...
                  <ul className="treeview-menu">
                    ...
                    <li>
                      <a href="panel-element-data-tables.html">
                        <i className="icon icon-table light-green-text"></i>Data
                        Tables
                      </a>
                    </li>
                  </ul>
                  ...
                  <ul className="treeview-menu">
                    ...
                    <li>
                      <a href="panel-element-jqvmap.html">
                        <i className="icon icon-map pink-text s-14"></i>Jqvmap
                      </a>
                    </li>
                    <li>
